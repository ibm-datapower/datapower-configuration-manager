...
<!-- 
  ...
  This stylesheet generates an Ant script that will upload key files to DataPower and create
  Crypto Key objects to wrap those files.
        ...
        <xsl:element name="antscript">
          ...
          <xsl:choose>
            <xsl:when test="$dcmdef/dcm:definition">
              ...
              <xsl:choose>
                <xsl:when test="$dcmdef/dcm:definition/dcm:key">
                  
                  <xsl:apply-templates select="$dcmdef/dcm:definition/dcm:key" mode="processDefinition"/>
                  
                </xsl:when>
                <xsl:otherwise>
                  
                  <xsl:element name="dcm:error">This file doesn't contain an dcm:definition/dcm:key elements!</xsl:element>
